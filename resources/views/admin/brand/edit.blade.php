@extends('admin.layouts.main') @section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('brand.update', $brand->id) }}" method="post" id="brand-form">
                @csrf
                @method('put')
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('is_active', $brand->name) }}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        readonly  value="{{ old('is_active', $brand->slug) }}">
                                    @error('slug')
                                        <p class="invalid-feedback">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="status"
                                        ...
                                        @if (old('is_active', $brand->is_active) == 1)
                ...
                <div class="pb-5 pt-3">
                    <button class="btn btn-primary" type="submit" id="submit-brand">Edit</button>
